...
<head>
    ...
    <title>EduCampus - Login</title>
    <meta name="description" content="EduCampus login portal for students, lecturers, and administrators.">
...
<body class="font-sans bg-muted min-h-screen flex items-center justify-center p-4">
    <div class="w-full max-w-md">
        ...
        <div class="text-center mb-8">
            ...
            <p class="text-secondary">Sign in to continue to EduCampus</p>
        </div>
        ...
        <div class="bg-white rounded-card p-8 shadow-sm">
            <!-- Session Status -->
            @if (session('status'))
                <div class="mb-4 p-4 rounded-2xl bg-success-light text-success text-sm font-medium">
                    {{ session('status') }}
                </div>
            @endif
            ...
            <form method="POST" action="{{ route('login') }}">
                ...
                <div class="mb-4">
                    ...
                    <div class="relative">
                        ...
                        <button type="button" onclick="togglePassword()" class="absolute right-4 top-1/2 -translate-y-1/2 text-secondary hover:text-foreground transition-colors">
                ...
                <div class="flex items-center justify-between mb-6">
                    ...
                    @if (Route::has('password.request'))
                        <a href="{{ route('password.request') }}" class="text-sm text-primary font-medium hover:underline">
                            Forgot password?
                        </a>
                    @endif
                </div>
